<template>
  <div class="space-y-4">
    ...
    <!--  <header class="px-4 py-3 border-b border-gray-100">-->
    <!--    <div class="flex items-center gap-2">-->
    <!--      <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-emerald-600" viewBox="0 0
24 2<!--ill="none" stroke="currentColor">-->
    <!--        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v2a2 2
0 00<!--12a2 2 0 002-2v-2M7 10l5-5m0 0l5 5m-5-5v12"/>-->
    <!--      </svg>-->
    <!--      <div>-->
  ...
  <!--      @click="emit('toggle-data-import')"-->
    <!--      class="w-full flex items-center justify-center gap-2 rounded-md bg-emerald-600
text-white font-medium py-2.5 px-4 hover:bg-emerald-700 transition-colors"-->
  <!--    >-->
    <!--      <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24
24" stroke="currentColor">-->
  <!--        <path-->
  <!--          stroke-linecap="round" stroke-linejoin="round" stroke-width="2"-->
    <!--          d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M9 19l3 3m0 0l3-3m-3
3V10"-->
    <!--        />-->
    <!--      </svg>-->
    <!--      Import Data-->
